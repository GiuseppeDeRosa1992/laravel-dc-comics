...
# lancia da termianle php artisan make:model "nome che serve iniziale maiuscolo" per creare la classe "Singolare"

# lancia da termianle php artisan make:migration create_plurale_table
